...
public class A_Classes_And_Objects {
...
//		speed = 10; // we cannot access class variable without creating objects.
		...
		A_Classes_And_Objects bike = new A_Classes_And_Objects();		// creating objects.  why? --> to access class variables. i.e Vehicle variable
		A_Classes_And_Objects car = new A_Classes_And_Objects();
		A_Classes_And_Objects train = new A_Classes_And_Objects();
		A_Classes_And_Objects aeroplane = new A_Classes_And_Objects();

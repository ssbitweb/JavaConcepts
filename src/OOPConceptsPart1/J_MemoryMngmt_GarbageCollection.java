...
// Pool memory -- stores immutable objects..all string classes and string pool --run time
...
public class J_MemoryMngmt_GarbageCollection {
	...
	public static void main(String[] args) {
		J_MemoryMngmt_GarbageCollection obj = new J_MemoryMngmt_GarbageCollection();
		obj.m1();

...
public class H_MethodOverloading {
	...
	// MethodOverloading-- > same method name with different numbers of parameter or different types or diff order of parameter.
	

	public static void main(String[] args) {
		
		H_MethodOverloading m = new H_MethodOverloading();
		m.sum();
		m.sum(10);
		m.sum(10, 20);
		m.sum(100, "sachin");
